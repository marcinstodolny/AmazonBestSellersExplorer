...
export class RegisterPageComponent {
  ...
  protected readonly form = this.formBuilder.group({
    username: ['', [Validators.required, Validators.minLength(5), Validators.maxLength(50), Validators.pattern(/^[A-Za-z0-9]+$/)]],
  ...
  protected readonly usernameError = computed(() => {
    ...
    if (control.hasError('pattern')) {
      return 'Username can contain only ASCII letters and digits.';
    }
  ...
  protected submit(): void {
    ...
    const request: RegisterUserRequest = this.form.getRawValue();
